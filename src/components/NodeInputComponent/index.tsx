...
interface NodeProps {
    ...
    nodeType: string;
    selected: boolean;
    onMouseDownNode: (id: string, event: any, nodeType: string) => void;
...
const NodeInputComponent: Component<NodeProps> = (props: NodeProps) => {
    // Handlers
    ...
    return (
        <div
            ...
            onMouseDown={(event: any) => {
                ...
                props.onMouseDownNode(props.id, event, "nodeInput");
            }}
        >
            ...
            <div class={styles.inside}>
                <div class={styles.title}>Node Input</div>
            </div>
